...
public class Restaurant {
	...
	public String listaDePlatos() {
			String lista ="";
			for (int i = 0; i < getPlatosDelRestaurant().length; i++) {
				lista += platosDelRestaurant[i].getNombreDelPlato()+" "+ getPlatosDelRestaurant()[i].getPrecioDelPlato() +"\n";
			}
		return	lista;
			
	}
	
	public Plato[] getPlatosDelRestaurant() {
		return platosDelRestaurant;
	}

	public void setPlatosDelRestaurant(Plato[] platosDelRestaurant) {
		this.platosDelRestaurant = platosDelRestaurant;
	}

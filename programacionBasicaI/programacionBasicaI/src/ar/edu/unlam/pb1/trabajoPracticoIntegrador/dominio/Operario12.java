...
public class Operario12 {
	...
	public Operario12(int legajo, String nombre, String apellido, int cantidadDiasLaborables) {
		this.legajo = legajo;
		this.nombre = nombre;
		...
		Operario12.cantidadOperarios++;
	}
	
	public Operario12 (int legajo, String nombre, String apellido, int cantidadDiasLaborables, String fechaIngreso) {
		this.legajo = legajo;
		this.nombre = nombre;
		this.apellido = apellido;
	...
	public static int getCantidadOperarios() {
		return Operario12.cantidadOperarios;
	}

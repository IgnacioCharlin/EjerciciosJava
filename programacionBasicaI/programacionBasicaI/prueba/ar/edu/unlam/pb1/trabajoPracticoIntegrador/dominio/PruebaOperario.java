...
public class PruebaOperario {
	...
	public static Operario12 cargarOperarioPuntual() {
		Operario12 operarioPuntual = new Operario12(1, "Juan", "Perez", CANTIDAD_DIAS_LABORALES, "26/06/2017");
	...
	public static Operario12 cargarOperarioImpuntual() {
		
		Operario12 operarioImpuntual = new Operario12(2, "Camila", "Lopez", CANTIDAD_DIAS_LABORALES, "29/06/2018");

...
import ar.edu.unlam.pb1.trabajoPracticoIntegrador.dominio.Empresa123;
import ar.edu.unlam.pb1.trabajoPracticoIntegrador.dominio.Operario12;

public class PruebaEmpresa {

	private static Empresa123 empresa;
	...
	public static void main(String[] args) {
		...
		empresa = new Empresa123(CANTIDAD_OPERARIOS, CANTIDAD_DIAS_LABORABLES);
	...
	private static void ingresarOperarios() {
		...
		for(int i = 0; i<CANTIDAD_OPERARIOS; i++) {
			...
			if(fechaIngreso == "") {
				nuevoOperario = new Operario12(legajo, nombre, apellido, CANTIDAD_DIAS_LABORABLES);
			}
			else {
				nuevoOperario = new Operario12(legajo, nombre, apellido, CANTIDAD_DIAS_LABORABLES, fechaIngreso);
			}
			...
			for(int j=0; j<CANTIDAD_DIAS_LABORABLES; j++) {
				...
				fecha = teclado.next();
				for(int k=0; k<Operario12.getCantidadOperarios(); k++) {
	...
	private static void buscarOperarioConMayorAntiguedad() {
		String fechaActual = "";
		Operario12 operarioConMayorAntiguedad;
	...
	private static void cargarEmpresaDePrueba() {
		Operario12 operarioPuntual = new Operario12(1, "Juan", "Puntualidad", CANTIDAD_DIAS_LABORABLES, "26/06/2017");
		...
		Operario12 operarioImpuntual = new Operario12(2, "Camila", "Impuntualidad", CANTIDAD_DIAS_LABORABLES, "29/06/2018");
